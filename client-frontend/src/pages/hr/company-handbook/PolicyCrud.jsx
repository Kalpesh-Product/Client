...
const PolicyCrud = () => {
      ...
      cellRenderer: (params) => (
        <div className="flex gap-4">
          <Button
            size="small"
            // onClick={() => handleDelete(params.row)}
            onClick={() => navigate("/hr/company-handbook/policy-details")}
            // onClick={handleDeleteTicket}
            variant="contained"
            sx={{
              backgroundColor: "blue",
  ...
  const allRows = [
    {
      id: 1,
      policyName: "BIZNest Leave Policy",
    ...
    {
      id: 2,
      policyName: "BIZNest Timings Policy",
      agreement: "New Year",
      priority: "Medium",
      status: "Pending",
      department: "HR",
    ...
    {
      id: 3,
      policyName: "BIZNest Co-working Policy",
      agreement: "Labor Day",
      priority: "High",
      status: "Pending",
      department: "Tech",
  ...
  const handleAddTicket = (newTicket) => {
    ...
    toast.success("Added a new policy.");
    closeModal(); // Optionally close the modal after the alert
  };
  ...
  const steps = ["Add Policy", "Verify Details"];
                    ...
                    <div className="p-6">
                      ...
                      <div>
                        <div className="flex justify-between py-2 border-b">
                          <h1 className="font-semibold">Policy Name</h1>
                          <span>New Test Policy</span>
                        </div>
                      </div>
                      {/* <div>
                        <div className="flex justify-between py-2 border-b">
