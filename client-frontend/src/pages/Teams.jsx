    ...
    { field: "Role", headerName: "Role", width: 200 },
    {
      ...
      cellClassName: (params) => {
        if (params.value === "High")
          return "bg-red-400 text-white px-4 py-1 rounded-full text-center";
        if (params.value === "Medium")
          return "bg-yellow-400 text-black px-4 py-1 rounded-full text-center";
        if (params.value === "Low")
          return "bg-green-400 text-white px-4 py-1 rounded-full text-center ";
    ...
    <div className="flex min-h-screen">
      <div className="w-full py-4 motion-preset-blur-right-md ">
        ...
        <div className="bg-white p-2">
          ...
          <div className="mt-5 overflow-auto w-full max-w-screen-xl motion-preset-blur-right-md ">
